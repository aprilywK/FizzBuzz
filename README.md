...
1. both have for loops and they have a variable in the first line of the for loop
2. use similar symbols (==, %)
3. use same if statement structure
4. use quotation mark to indicate string
5. use print statement to print output
